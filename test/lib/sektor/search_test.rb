...
class SearchTest < Minitest::Test
  ...
  def test_all_results
    assert_equal [
      ...
      {:id=>"243616653_271086345", :artist=>"Земфира/Queen", :title=>"We are the champions", :time=>245, :size=>1433, :bitrate=>64, :link=>"http://s.myfreemp3.space/s.php?q=243616653_271086345"},
      {:id=>"-51614034_337392344", :artist=>"Село i Люди", :title=>"We Are The Champions (Queen)", :time=>62, :size=>1433, :bitrate=>64, :link=>"http://s.myfreemp3.space/s.php?q=-51614034_337392344"},
      {:id=>"236898965_343681340", :artist=>"Богдан Палий", :title=>"We are the champions", :time=>186, :size=>1433, :bitrate=>64, :link=>"http://s.myfreemp3.space/s.php?q=236898965_343681340"},
      {:id=>"22226641_163479057", :artist=>"-", :title=>"Ода бороде (We Are The Champions)", :time=>103, :size=>1433, :bitrate=>64, :link=>"http://s.myfreemp3.space/s.php?q=22226641_163479057"},
      {:id=>"7978948_364145213", :artist=>"Instrumental Champions", :title=>"We Are The World", :time=>287, :size=>1433, :bitrate=>64, :link=>"http://s.myfreemp3.space/s.php?q=7978948_364145213"}
